...
export default function VisionMissionSection() {
    return (
        <section className="relative min-h-screen lg:min-h-[1400px] text-white  overflow-hidden lg:px-0">
            {/* 1. Background Purple Logo/Lines Image */}
            <div className="absolute inset-x-0 top-0 h-[800px]  lg:h-[1000px] z-0 pointer-events-none opacity-40 lg:opacity-50   translate-y-[50px] lg:translate-y-[100px]">
                <div className="relative w-[80%] h-full max-w-[1400px]  top-[250px]">
                    <Image
            ...
            <div className="container mx-auto max-w-7xl relative z-10 h-full">
                ...
                <div className="flex justify-center lg:justify-end lg:mr-[20%] mb-16 lg:mt-20  relative z-20">
                    <motion.div
                ...
                <div className="relative z-20 mt-44 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
                    <div className="flex flex-col items-center -mt-24 lg:items-start lg:pl-[22%]">
                        ...
                        <motion.p
                            ...
                            className="text-gray-400  text-sm md:text-base  max-w-[400px] px-4 lg:px-0 lg:pl-6 lg:border-l lg:border-white/10 "
                        >
            ...
            {/* Atmosphere Glows */}
            <div className="absolute top-[20%] left-[-10%] w-[800px] h-[800px] blur-[160px] rounded-full pointer-events-none -z-10" />
            <div className="absolute bottom-[10%] right-[-10%] w-[900px] h-[900px] blur-[200px] rounded-full pointer-events-none -z-10" />
        </section>
    );
}
