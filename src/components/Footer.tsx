...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-gray-900 text-gray-400 py-16 text-sm">
      <div className="container  max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex flex-col flex-wrap md:flex-nowrap md:flex-row w-full items-start gap-12 mb-12">

          {/* Brand Column */}
          <div className="space-y-6 md:w-1/2">
            <div className="flex items-center space-x-2">
              <div className="w-44 aspect-[16/4] flex items-center justify-center  rounded-lg">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:bg-purple-500 hover:text-white transition">
                <Image width={8} height={8} src={'/assets/facebook.svg'} alt="bg-2" />
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:bg-purple-500 hover:text-white transition">
                <Image width={14} height={14} src={'/assets/twitterblack.svg'} alt="bg-2" />

              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:bg-purple-500 hover:text-white transition">
                <Image width={14} height={14} src={'/assets/insta-black.svg'} alt="bg-2" />
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:bg-purple-500 hover:text-white transition">
                <Image width={14} height={14} src={'/assets/linkedinblack.svg'} alt="bg-2" />
              </a>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-4  text-white">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className='text-xs'>Arrant Services LLC, 1517 FM 359 Rd, Suite 400, Richmond, TX 77406.</span>
                </li>
              </ul>
            </div>
          </div>
