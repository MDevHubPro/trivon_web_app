...
export default function CustomDevHero() {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-10 sm:top-16 flex flex-col  sm:flex-row justify-center sm:justify-end gap-4 items-center text-center sm:text-left">
                ...
                <div className="mt-4 sm:mt-0 flex flex-col justify-center items-end md:items-center sm:items-start">
                    ...
                    <p className="text-gray-400 text-xs sm:text-sm mt-4 max-w-xs sm:max-w-md">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 right-4 sm:right-10 md:right-20">
                <h3 className="flex items-center font-medium tracking-tighter text-[70px] text-nowrap sm:text-[120px] md:text-[160px] bg-[linear-gradient(90deg,#FFFFFF_0%,#000000_100%)] bg-clip-text text-transparent">
                    <span>*/</span>
                    <span className="ml-2">Web Dev</span>
                </h3>
            </div>
